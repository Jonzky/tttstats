...
?>
	...
	<p><b>2c.</b> goto /dblogging/lua/dbmodules/client/cl_showstats changing the variable "url" to include your own web servers address to the file called "motd.php" so www.yourwebsitehere.com/ttt_stats/motd.php making sure to add the steamid get statement ("motd.php?steamid=%s") </p>
	<p><b>3.</b> Once all of the above steps have been completed your server is ready for stat tracking!</p>
